  ...
  const services = [
    {
      ...
      description: "Our AI-powered website development service combines cutting-edge design with intelligent functionality to create websites that not only look beautiful but actively work to convert visitors into customers.",
      benefits: [
    ...
    },
    {
      ...
      description: "Transform your customer service operations with AI-powered solutions that provide instant, accurate responses to customer queries while significantly reducing operational costs.",
      benefits: [
      ...
      image: "https://images.unsplash.com/photo-1573164574572-cb89e39749b4?fit=crop&w=800&h=500"
    },
    {
      id: "automation",
      icon: Settings,
      ...
      description: "Identify and automate repetitive, time-consuming business processes to increase efficiency, reduce errors, and free up your team to focus on high-value strategic tasks.",
      benefits: [
      ...
      image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?fit=crop&w=800&h=500"
    },
    {
      id: "scalable",
      icon: LineChart,
      title: "Scalable AI Solutions",
      subtitle: "Custom AI implementations for growing businesses",
      description: "Tailored AI solutions designed to address your unique business challenges and scale seamlessly as your organization grows, providing long-term value and competitive advantage.",
      benefits: [
        "Custom AI model development and training",
        "Flexible implementation options (cloud, on-premise, hybrid)",
        "Phased deployment approach to minimize disruption",
        ...
        <div className="maxscale-container py-16">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-300 text-lg">
              MaxScale offers comprehensive AI solutions designed to optimize your business operations,
