        ...
        <div className="maxscale-container py-16">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-300 text-lg">
              Have questions about our AI solutions? Ready to start scaling your business? 
            ...
            <div className="glass-panel p-8">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">123 Innovation Street, Tech City, TC 10111</p>
                  </div>
                </div>
              ...
              <div className="bg-maxscale-muted p-6 rounded-lg">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-maxscale-light flex items-center justify-center text-white hover:bg-maxscale-accent transition-colors">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="customer-service">AI Customer Service Solutions</option>
