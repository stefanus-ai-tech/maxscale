  ...
  const caseStudies = [
    {
      ...
      solution: "Implemented AI-powered recommendation engine and chatbot assistance",
    ...
    },
    {
      ...
      industry: "Healthcare",
      challenge: "Manual data entry causing delays and errors in patient records",
      ...
      image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?fit=crop&w=800&h=500"
    }
  ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="mb-6">
                        <h3 className="text-maxscale-accent font-semibold mb-1">Challenge:</h3>
                        <p className="text-gray-300">{study.challenge}</p>
                      </div>
                      
                      <div className="mb-6">
                        <h3 className="text-maxscale-accent font-semibold mb-1">Solution:</h3>
                        <p className="text-gray-300">{study.solution}</p>
                      </div>
                      
                      <div className="mb-6">
                        <h3 className="text-maxscale-accent font-semibold mb-1">Results:</h3>
