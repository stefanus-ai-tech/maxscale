        ...
        <div className="maxscale-container py-16">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-300 text-lg">
              Choose the plan that fits your business needs. All plans include our core AI technology 
                ...
                <ul className="space-y-3 mb-8 flex-grow">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start">
                      <Check className="text-maxscale-accent mr-2 mt-1 flex-shrink-0" size={18} />
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="md:w-3/5">
                ...
                <p className="text-gray-300">
                  Our team can create a tailored AI package that perfectly meets your specific business requirements 
                  and challenges. Contact us to discuss your needs.
                </p>
              </div>
