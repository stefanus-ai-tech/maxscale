...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: [
        "Craft and execute go-to-market strategies using AI-enhanced tools for speed, precision, and scale.",
        "Manage end-to-end marketing operations—from audience targeting, content creation, to performance analytics—tailored for startups and high-growth businesses.",
      ],
    },
  ];
      ...
      <div className="maxscale-container relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-300 text-lg animate-fade-in opacity-0 [animation-delay:400ms]">
            We provide comprehensive AI solutions that help businesses
