...
const ClientsSection = () => {
  const clients = [{
    name: 'TechCorp',
    logo: 'https://via.placeholder.com/150x50/2A2A35/FFFFFF?text=TechCorp'
  }, {
    name: 'InnovatePro',
    logo: 'https://via.placeholder.com/150x50/2A2A35/FFFFFF?text=InnovatePro'
  }, {
    name: 'FutureWave',
    logo: 'https://via.placeholder.com/150x50/2A2A35/FFFFFF?text=FutureWave'
  }, {
    name: 'NexGen',
    logo: 'https://via.placeholder.com/150x50/2A2A35/FFFFFF?text=NexGen'
  }, {
    name: 'DigitalPlus',
